...
export default function Dashboard() {
  ...
  useEffect(() => {
    const getData = async () => {
      const response = await axios.get(
        "https://sandrahermajesty.onrender.com/PostgreSQL/API/users/get/users"
      );
      const data = response.data.data;
      setUsers(data);
    };
  ...
  useEffect(() => {
    const getData = async () => {
      const response = await axios.get(
        "https://postgresql-2c0g.onrender.com/PostgreSQL/API/comments/all"
      );
      const data = response.data.data;
      setComments(data);
    };
  ...
  useEffect(() => {
    const getData = async () => {
      const response = await axios.get(
        "https://postgresql-2c0g.onrender.com/PostgreSQL/API/replies/all"
      );
      const data = response.data.data;
      setReply(data);
    };
